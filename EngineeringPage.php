	...
	<h3>EECS 281: Data Structures and Algorithms</h3>
		<section>
			<div id="EECS281" class ="course">
				<p class="description">Introduction to algorithm analysis and O-notation; Fundamental data structures including lists, stacks, queues, priority queues, hash tables, binary trees, search trees, balanced trees and graphs; searching and sorting algorithms; recursive algorithms; basic graph algorithms; introduction to greedy algorithms and divide and conquer strategy. Several programming assignments.</p>
				<p class="data"></p>
				<p class="comments"></p>
			</div>
		</section>
	<h3>EECS 285: A Programming Language or Computer System</h3>
		<section>
			<div id="EECS285" class ="course">
				<p class="description">A course covering a complex computer system or programming language. Programming problems will be assigned. Specific languages or systems to be offered will be announced in advance.</p>
				<p class="data"></p>
				<p class="comments"></p>
			</div>
		</section>
	<h3>EECS 485</h3>
		<section>
			<div id="EECS485" class ="course">
				<p class="description">Concepts surrounding Web information systems, including client/server systems, security, XML, information retrieval and search engines and data replication issues. Includes substantial final project involving development of a database-backed web site.</p>
				<p class="data"></p>
				<p class="comments"></p>
			</div>
		</section>
