	...
	<div id="center">
		...
		<section>
			<div id="EECS280" class ="course">
				<div class="row">
					<div class="col-md-8"><p class="description">Techniques and algorithm development and effective programming, top-down 
		...
		<section>
			<div id="EECS281" class ="course">
				<div class="row">
					<div class="col-md-8"><p class="description">Introduction to algorithm analysis and O-notation; Fundamental data structures 
