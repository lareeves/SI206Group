			...
			<div id="STATS" class ="course">
				...
				<button class = "comButton" onclick="showText('STATS_COM')">Comments...</button>
					<table class="comments" id="STATS_COM">
						...
						<tr>
							<td>Great intro course for stats. I’m currently taking my third stats course at Michigan and this class is by far the easiest, but is a great introduction. Go to class. You will learn better that way.</td>
			...
			<div id="Calc" class ="course">
				...
				<button class = "comButton" onclick="showText('CALC_COM')">Comments...</button>
					<table class="comments" id="CALC_COM">
						...
						<tr>
							<td>The material is generally easy to grasp, but the exams are much harder than they need to be. Also really didn’t like the GSI’s.</td>
							<td class="userInfo">Informatics, 2016 | 1/27/13</td>
						</tr>
						<tr>
							<td>Math is my thing and this class was really easy for me. Had the textbook, but barely used it. Group assignments were annoying, but really not that bad.</td>
			...
			<div id="Spanish" class ="course">
				...
				<button class = "comButton" onclick="showText('SPAN_COM')">Comments...</button>
					<table class="comments" id="SPAN_COM">
						...
						<tr>
							<td>Loved this class! Super easy and the material we read was actually interesting. My professor was great and the class discussion was always enjoyable!</td>
							<td class="userInfo">Spanish Major, 2014 | 2/5/13</td>
						</tr>
						<tr>
							<td>Not a terribly difficult class, but certainly not easy. I found myself reading spanish passages over and over again. If you are really good at Spanish then this class should be fine for you.</td>
			...
			<div id="Film" class ="course">
				...
				<button class = "comButton" onclick="showText('SAC_COM')">Comments...</button>
					<table class="comments" id="SAC_COM">
						...
						<tr>
							<td>Thought this class would be easy and interesting, but I hated the director that we focused on, and my class was curved to a B! Had no idea until I got my first assignment back.</td>
							<td class="userInfo">Sociology Major, 2016 | 1/4/14</td>
						</tr>
						<tr>
							<td>Great intro to film class. Teaches you a lot about the fundamentals of movies and makes you look at all films differently forever. Grading really depends on your GSI though.</td>
