	...
	<div id="center">
		...
		<section>
			<div id="SI110" class ="course">
				<div class="row">
					<div class="col-md-8"><p class="description">Introduction to Information Studies --- This course will provide the foundational knowledge 
																necessary to begin to address the key issues associated with the Information Revolution. Issues 
				...
				<div class="text-left">
					<button class = "btn btn-default" onclick="showText('SI110_COM')">Comments...</button>
				</div>
		...
		<section>
			<div id="SI206" class ="course">
				...
				<div class="text-left">
					<button class = "btn btn-default" onclick="showText('SI206_COM')">Comments...</button>
				</div>
		...
		<section>
			<div id="SI339" class ="course">
				...
				<div class="text-left">
					<button class = "btn btn-default" onclick="showText('SI339_COM')">Comments...</button>
				</div>
		...
		<section>
			<div id="SI363" class ="course">
				...
				<div class="text-left">
					<button class = "btn btn-default" onclick="showText('SI363_COM')">Comments...</button>
				</div>
		...
		<section>
			<div id="SI430" class ="course">
				<div class="row">
					<div class="col-md-8"><p class="description">Information Technology and Global Society --- In this course, students will examine
																 recent and current global events featuring information technology, and through both 
				...
				<div class="text-left">
					<button class = "btn btn-default" onclick="showText('SI430_COM')">Comments...</button>
				</div>
